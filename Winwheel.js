...
function Winwheel(options, drawWheel)
{
    defaultOptions = {
        ...
        'outerRadius'       : 5,         // The radius of the outside of the wheel. If left null it will be set to the radius from the center of the canvas to its shortest side.
        ...
        'lineWidth'         : 0,            // Width of lines around segments.
